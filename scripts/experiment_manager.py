...
if __name__ == '__main__':
	...
	# for config in ['teb1']:
		for tries in [1,2,3]:
			...
			try:
				print('rosbag1')
				rosbagnode = roslaunch.core.Node("rosbag", "record", name="record", args='-e "/metrics/.*" -O $(find model_training)/results/exp1/%s_%s_%s.bag'%(exp,sx,config))
